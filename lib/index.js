...
var _excluded = ["cssBaseLine", "peopleList", "avatarPeopleList", "downloadAvatarUrl", "genAvatarLink", "onChange", "onSubmit"],
    ...
    _excluded8 = ["cssBaseLine", "preHtml", "downloadImageUrl", "downloadVoteUrl", "avatarPeopleList", "downloadAvatarUrl", "genAvatarLink"],
...
function DraftViewer(_ref8) {
  var _ref8$cssBaseLine = _ref8.cssBaseLine,
      ...
      downloadImageUrl = _ref8$downloadImageUr === void 0 ? "/api/picture/downloadPicture/" : _ref8$downloadImageUr,
      _ref8$downloadVoteUrl = _ref8.downloadVoteUrl,
      downloadVoteUrl = _ref8$downloadVoteUrl === void 0 ? "/api/voteBlock/" : _ref8$downloadVoteUrl,
  ...
  var _useColorObj3 = useColorObj(5),
  ...
  var _React$useState3 = _react["default"].useState(props.mode || 'light'),
