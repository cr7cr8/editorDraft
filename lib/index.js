...
var _excluded = ["cssBaseLine", "colorIndex", "peopleList", "avatarPeopleList", "downloadAvatarUrl", "genAvatarLink", "onChange", "onSubmit"],
    ...
    _excluded8 = ["cssBaseLine", "colorIndex", "preHtml", "downloadImageUrl", "downloadVoteUrl", "avatarPeopleList", "downloadAvatarUrl", "genAvatarLink"],
...
function DraftViewer(_ref8) {
  var _ref8$cssBaseLine = _ref8.cssBaseLine,
      ...
      colorIndex = _ref8$colorIndex === void 0 ? "2" : _ref8$colorIndex,
  ...
  var _useColorObj3 = useColorObj(Number(colorIndex)),
