...
function ThemeContextProvider(_ref) {
  ...
  var _useState3 = (0, _react.useState)(themeSizeObj || {
    xs: "1.5rem",
    sm: "1.5rem",
    md: "1.5rem",
    lg: "1.5rem",
  ...
  return /*#__PURE__*/_react["default"].createElement(_styles.ThemeProvider, {
    theme: myTheme
  }, cssBaseLine && /*#__PURE__*/_react["default"].createElement(_material.CssBaseline, null), children);
}
...
function EditorContextProvider(_ref8) {
  ...
  var _useState5 = (0, _react.useState)(_draftJs.EditorState.createWithContent((0, _draftJs.convertFromRaw)(rawJsText)) || _draftJs.EditorState.createEmpty()),
      _useState6 = _slicedToArray(_useState5, 2),
      editorState = _useState6[0],
      setEditorState = _useState6[1];

  var _useState7 = (0, _react.useState)("ddd"),
      _useState8 = _slicedToArray(_useState7, 2),
      currentBlockKey = _useState8[0],
      setCurrentBlockKey = _useState8[1];

  var _useState9 = (0, _react.useState)({}),
      _useState10 = _slicedToArray(_useState9, 2),
      imageObj = _useState10[0],
      setImageObj = _useState10[1];
  ...
  var _useState11 = (0, _react.useState)(props.peopleList || []),
      _useState12 = _slicedToArray(_useState11, 2),
      peopleList = _useState12[0],
      setPeopleList = _useState12[1];

  var _useState13 = (0, _react.useState)(props.avatarPeopleList || []),
      _useState14 = _slicedToArray(_useState13, 2),
      avatarPeopleList = _useState14[0],
      setAvatarPeopleList = _useState14[1];

  var _useState15 = (0, _react.useState)([]),
      _useState16 = _slicedToArray(_useState15, 2),
      voteArr = _useState16[0],
      setVoteArr = _useState16[1];

  var _useState17 = (0, _react.useState)(""),
      _useState18 = _slicedToArray(_useState17, 2),
      voteId = _useState18[0],
      setVoteId = _useState18[1];

  var _useState19 = (0, _react.useState)(""),
      _useState20 = _slicedToArray(_useState19, 2),
      voteTopic = _useState20[0],
      setVoteTopic = _useState20[1];
  ...
  var _useState21 = (0, _react.useState)({
    ...
    m: 0
      ...
      pollDuration = _useState22[0],
      setPollDuration = _useState22[1];
