...
function DraftEditor(_ref) {
  ...
  var _useColorObj = useColorObj(Number(colorIndex) % colorArr.length),
  ...
  var _React$useState = _react["default"].useState(themeMode || 'light'),
      ...
      setMode = _React$useState2[1]; // useEffect(function () {
  //     setMode("themeMode")
  // }, [themeMode])
...
function DraftViewer(_ref8) {
  ...
  var _React$useState3 = _react["default"].useState(themeMode || 'light'),
      ...
      setMode = _React$useState4[1]; // useEffect(function () {
  //     setMode("themeMode")
  // }, [themeMode])
