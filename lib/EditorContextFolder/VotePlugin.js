...
exports["default"] = createVotePlugin;

var _draftJs = require("draft-js");

var _VoteBlock = _interopRequireDefault(require("./VoteBlock"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }

function createVotePlugin() {
  var editorState = null;
  var setEditorState = null;
  var newContent = null;

  function markingVoteBlock(blockKey) {
    ...
    var newContent = _draftJs.Modifier.setBlockType(editorState.getCurrentContent(), newSelection, isDeleting ? "unstyled" : "voteBlock");
